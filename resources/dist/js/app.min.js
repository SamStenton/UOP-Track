...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModuleItemGen = __webpack_require__(32);
	...
	class createModule extends Page {
	    ...
	    execute() {
	        ...
	        this.getByID('addSubmission').addEventListener('click', event => this.addItem(event));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormErrors = __webpack_require__(31);
	class Form {
	    /**
